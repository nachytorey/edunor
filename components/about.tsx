      ...
      <div className="container-luxe grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          ...
          <h2 className="mt-4 font-serif text-4xl md:text-5xl lg:text-6xl leading-tight text-balance">
            Más de <span className="text-primary italic">60 años</span> en el
            agua
          </h2>
          <p className="mt-6 text-foreground/70 leading-relaxed text-pretty">
            Edunor Náutica es una empresa familiar fundada en{' '}
            <strong className="text-foreground">1963</strong>, dedicada a la
            comercialización de los rubros Náutica, Camping y Outdoor — calzado
            e indumentaria de las mejores marcas. Una larga trayectoria
            trabajando para brindarle las mejores opciones para su tiempo libre.
          </p>
